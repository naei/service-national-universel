            ...
            <div className="flex flex-col gap-8 w-1/2 pl-10 py-6 pr-3">
              ...
              <div className="flex items-center gap-5">
                ...
                <div className="text-[#6B7280] text-sm leading-5 flex-1">
                  Votre dossier a été validé. L’administration du SNU vous contactera au plus vite pour vous informer de votre participation au Service National Universel. Vouse
