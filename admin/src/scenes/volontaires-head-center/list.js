                  ...
                  transform={(all) => {
                    return all.map((data) => {
                      ...
                      return {
                        ...
                        Région: data.region,
                        "Hébergeur en France": `${data.hostFirstName} ${data.hostLastName}`,
                        "Adresse de l'hébergeur": data.hostAddress,
                        "Code postal de l'hébergeur": data.hostZip,
                        "Ville de l'hébergeur": data.hostCity,
                        ...
                        Allergies: translate(data.allergies),
                        ...
                        "Affectation dans son département de résidence": translate(data.handicapInSameDepartment),
